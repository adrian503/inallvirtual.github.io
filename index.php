...
// $conexio=mysqli_query($conexion, "Select * From libros limint 0,6");
$consulta=mysqli_query($conexion,'select * from libros limit 0,6');
...
if ($nro_reg==0){
   ...
   $row = mysqli_fetch_array($result);
	...
	$result2=mysqli_query($conexion,"SELECT count(utc) as visitas from visitas WHERE fecha_visita = CURDATE( )");
...
<head>
    ...
    <title>Biblioteca RJCH | Inicio</title>
